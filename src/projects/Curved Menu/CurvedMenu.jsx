...
const CurvedMenu = () => {
  ...
  return (
    <div>
      ...
      >
        <div
          className={`w-full after:content-[''] after:relative after:transition-all after:duration-300 after:block after:w-[40%] after:bg-white after:h-[1px] after:m-auto after:-top-[5px] before:content-[''] before:relative before:transition-all before:duration-300 before:block before:w-[40%] before:bg-white before:h-[1px] before:m-auto before:top-[5px] ${
            isActive
      ...
      <AnimatePresence mode="wait">
        {isActive && (
          ...
          >
            <div className="p-[100px] h-full box-border flex flex-col justify-between">
