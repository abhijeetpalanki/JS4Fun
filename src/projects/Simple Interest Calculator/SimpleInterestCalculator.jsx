...
const SimpleInterestCalculator = () => {
  ...
  return (
    <div className="bg-[#0e0e0e] font-['Poppins'] flex justify-center items-center text-center h-screen m-0">
      <div className="shadow-[0_0_12px_rgb(255,255,255)] bg-[#faf9fa] w-[519px] h-[672px] rounded-lg p-12">
        <div className="text-[20px] font-normal">
          <h1 className="heading-one">Simple Interest Calculator</h1>
          <p className="pt-[5px]">Calculate your simple interest easily.</p>
        </div>
        <div className="w-[445px] h-[138px] bg-[#d6ff58] mt-[22px]">
          <div className="pt-10">
        ...
        <form onSubmit={calcSum}>
          ...
          <div className="mt-[61px] mb-4">
            <div className="flex flex-row gap-2">
              <button
                type="submit"
                className="bg-[#1f1f1f] w-[200px] h-[75px] text-white"
