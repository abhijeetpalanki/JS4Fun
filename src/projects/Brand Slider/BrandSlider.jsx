    ...
    <div className="flex items-center justify-center h-screen bg-white/70">
      <div className="grid place-items-center">
        <section className="">
          ...
          <div className="w-screen relative h-48 bg-white shadow-[0_0.8rem_1.4rem_-0.2rem_#0001] flex items-center overflow-hidden before:absolute after:absolute before:content-[''] after:content-[''] before:h-full after:h-full before:w-48 after:w-48 before:left-0 before:bg-linear-to-r before:from-white before:to-[#fff0] after:right-0 after:bg-linear-to-l after:from-white after:to-[#fff0]">
            <ul className="w-1344 flex animate-slideLeft">
              {brands.map((brand, i) => (
