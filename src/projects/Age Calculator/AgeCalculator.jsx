...
const AgeCalculator = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="w-112.5 py-12.5 px-7.5">
        {/* Inputs Wrapper */}
        <div className="bg-[#080808] py-7.5 px-6.25 rounded-lg shadow-[0_15px_20px_#0000004c] border-none outline-none mb-12.5">
          <input
            type="date"
            className="h-12.5 bg-white text-[#080808] font-medium rounded-[5px] w-[60%] py-0 px-5 text-[14px]"
            value={inputDate}
            onChange={(e) => setInputDate(e.target.value)}
          />
          <button
            className="h-12.5 bg-white text-[#080808] font-medium rounded-[5px] w-[30%] float-right"
        ...
        <div className="flex justify-between w-full">
          <div className="h-25 w-25 bg-[#080808] rounded-[5px] text-white grid place-items-center py-5 px-0 shadow-[0_15px_20px_#0000004c]">
