  ...
  return (
    ...
    >
      <div className="flex flex-col mb-10">
        ...
        <select className="breath-input border-none rounded-lg min-w-[300px] text-base py-2 px-1 bg-[#6236ff] text-white focus:outline-none">
      ...
      <div className="relative flex flex-col items-center justify-center mb-10">
        <div className="circle-outline w-[300px] h-[300px] rounded-full bg-transparent border-[15px] border-[#f1f1f1] shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1,0_4px_6px_-2px_hsla(0,0%,0%,0.05))]"></div>
        <div className="circle-progress w-[50px] h-[50px] absolute bg-[#6236ff] rounded-full transition-all duration-[4000ms] ease-linear shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1,0_4px_6px_-2px_hsla(0,0%,0%,0.05))]"></div>
      </div>
