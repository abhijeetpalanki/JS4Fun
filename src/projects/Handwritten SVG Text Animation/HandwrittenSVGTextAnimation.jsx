...
const HandwrittenSVGTextAnimation = () => {
  useEffect(() => {
    anime({
      targets: [".path"],
      loop: true,
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-[#35dad2] content-center">
      <h3>
        <svg
          version="1.1"
          className="subtitle w-[20em]"
...
export default HandwrittenSVGTextAnimation;
