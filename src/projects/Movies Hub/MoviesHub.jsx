...
const API_URL = `https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&api_key=${process.env.REACT_APP_MOVIES_API_KEY}&page=1`;
      ...
      <header className="bg-[#373b69] p-[1rem] flex justify-center">
        <form id="form" onSubmit={handleOnSubmit}>
          <input
            type="text"
            id="search"
            className="bg-transparent rounded-[50px] text-[1rem] py-[0.5rem] px-[1rem] text-white border-2 border-[#22254b] placeholder:text-[#ccc] focus:outline-none focus:bg-[#22254b]"
            placeholder="Search"
            value={searchTerm}
