...
Command: npx gltfjsx@6.2.13 public/models/PortfolioOffice.glb 
*/
...
export function PortfolioOffice(props) {
  const { section } = props;
  const { nodes } = useGLTF("/models/PortfolioOffice.glb");
...
useGLTF.preload("/models/PortfolioOffice.glb");
