...
const BlurryLoading = () => {
  ...
  return (
    <div className="font-['Ubuntu'] w-[100vw] h-[100vh] flex justify-center items-center overflow-hidden m-0">
      <section
        ref={bgRef}
        className="bg absolute top-0 left-0 w-[100vw] h-[100vh] z-0 blur-none"
